    ...
    public static class Utill
    {
        ...
        public static bool isValidPatient(Patient patient)
        {
            ...
            if (!SecurityUtil.isValidString(patient.Username))
            {
                System.Windows.Threading.Dispatcher.CurrentDispatcher.Invoke((Action)(() =>
                {
                    Messenger.ShowMessage(SecurityUtil.getErrorMessage("username"));
                }));
                return false;
            }
            ...
            if (!SecurityUtil.isValidString(patient.FirstName))
            {
                System.Windows.Threading.Dispatcher.CurrentDispatcher.Invoke((Action)(() =>
                {
                    Messenger.ShowMessage(SecurityUtil.getErrorMessage("first name"));
                }));
                return false;
            }

            if (!SecurityUtil.isValidString(patient.LastName))
            {
                System.Windows.Threading.Dispatcher.CurrentDispatcher.Invoke((Action)(() =>
                {
                    Messenger.ShowMessage(SecurityUtil.getErrorMessage("last name"));
                }));
                return false;
            }
            ...
            if (!SecurityUtil.isEGN(patient.EGN))
            {
                System.Windows.Threading.Dispatcher.CurrentDispatcher.Invoke((Action)(() =>
                {
                    Messenger.ShowMessage(SecurityUtil.getErrorMessage("egn"));
                }));
                return false;
            }
            ...
            if (!SecurityUtil.isValidDate(patient.BirhtDate))
            {
                System.Windows.Threading.Dispatcher.CurrentDispatcher.Invoke((Action)(() =>
                {
                    Messenger.ShowMessage(SecurityUtil.getErrorMessage("birth date"));
                }));
                return false;
            }
